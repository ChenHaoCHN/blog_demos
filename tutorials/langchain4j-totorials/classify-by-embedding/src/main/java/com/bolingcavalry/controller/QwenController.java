...
public class QwenController {
    ...
    @PostMapping("/output/classify")
    public ResponseEntity<Response> classify(@RequestBody PromptRequest request) {
        ...
        try {
            String response = qwenService.classify(request.getPrompt());
